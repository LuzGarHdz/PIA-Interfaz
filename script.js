...
(function setupPageTransitions() {
  const DURATION = 400; // debe coincidir con el CSS

  // Quitar la clase cuando volvemos con el botón "atrás" del navegador
  window.addEventListener("pageshow", () => {
    document.body.classList.remove("is-transitioning");
  });

  // Delegamos en todo el documento para no depender de dónde esté el <a>
  document.addEventListener("click", (e) => {
    ...
    // Ignorar abrir en nueva pestaña / modificadores
    if (
    ...
    // Si tiene data-no-transition, lo dejamos normal
    ...
    // Después del fade, cambiamos de página
    setTimeout(() => {
